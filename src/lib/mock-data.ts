...
export const events: Event[] = [
  { id: "e1", name: "State of the Student Address 2nd Semester A.Y. 2025-2026", description: "Annual State of the Student Address for all USSC members. Attendance is mandatory.", date: "2024-09-15", location: "University Auditorium", type: "general-assembly", attendeesCount: 156, totalStudents: 200 },
...
export const eventAttendance: EventAttendance[] = [
  { id: "ea1", eventId: "e1", eventName: "State of the Student Address 2nd Semester A.Y. 2025-2026", studentId: "2024-00101", studentName: "Maria Santos", status: "present", timeIn: "08:30" },
  { id: "ea2", eventId: "e1", eventName: "State of the Student Address 2nd Semester A.Y. 2025-2026", studentId: "2024-00102", studentName: "Juan Dela Cruz", status: "present", timeIn: "08:45" },
  { id: "ea3", eventId: "e1", eventName: "State of the Student Address 2nd Semester A.Y. 2025-2026", studentId: "2024-00103", studentName: "Angela Reyes", status: "absent" },
  { id: "ea4", eventId: "e1", eventName: "State of the Student Address 2nd Semester A.Y. 2025-2026", studentId: "2024-00105", studentName: "Patricia Navarro", status: "present", timeIn: "08:15" },
  { id: "ea5", eventId: "e1", eventName: "State of the Student Address 2nd Semester A.Y. 2025-2026", studentId: "2024-00106", studentName: "Miguel Torres", status: "excused" },
...
export const fines: Fine[] = [
  { id: "fn1", studentId: "2024-00103", studentName: "Angela Reyes", reason: "Absent - State of the Student Address 2nd Semester A.Y. 2025-2026", amount: 50, status: "unpaid", dateIssued: "2024-09-16", eventId: "e1", autoGenerated: true },
  ...
  { id: "fn4", studentId: "2024-00110", studentName: "Daniel Villanueva", reason: "Absent - State of the Student Address 2nd Semester A.Y. 2025-2026", amount: 50, status: "unpaid", dateIssued: "2024-09-16", eventId: "e1", autoGenerated: true },
